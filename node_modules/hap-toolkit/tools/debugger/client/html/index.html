<!DOCTYPE html><html><head><meta charset="UTF-8"><title>调试器</title><link href="../js/../css/index/index-0702f7c6dbc18b74dab1.css" rel="stylesheet"></head><body class="bd-bg"><section class="qr-code-wrapper"><div><div class="qr-code-panel"><div class="qr-img"><img src="" id="j-qr-icon" class="qr-icon"></div><div class="alert alert-warning updatetip"><p>1. 扫码安装rpk包</p><p>2. 在手机的调试器上点击<button class="btn btn-default">开始调试</button>，启动调试界面</p></div></div></div></section><section class="inform-tip-wrapper"></section><section class="result inspector-link-panel hide"><div class="panel panel-default"><div class="panel-heading">调试</div><div class="panel-body"><table class="table tunning"><tbody></tbody></table></div></div></section><script type="text/template" id="j-tpl-appinfo"><tr>
      ...
      </div></script><script src="//cdnjs.cloudflare.com/ajax/libs/socket.io/2.0.4/socket.io.js"></script><script type="text/javascript" src="../js/index-0702f7c6dbc18b74dab1.js"></script></body></html>